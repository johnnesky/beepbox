package {
	...
	public class Synth {
		...
		private const waves: Vector.<Vector.<Number>> = new <Vector.<Number>> [
			...
			//new <Number>[Math.sin(Math.PI * 0.0 / 6.0), Math.sin(Math.PI * 1.0 / 6.0), Math.sin(Math.PI * 2.0 / 6.0), Math.sin(Math.PI * 3.0 / 6.0), Math.sin(Math.PI * 3.0 / 6.0), Math.sin(Math.PI * 3.0 / 6.0), Math.sin(Math.PI * 4.0 / 6.0), Math.sin(Math.PI * 5.0 / 6.0), Math.sin(Math.PI * 6.0 / 6.0), Math.sin(Math.PI * 7.0 / 6.0), Math.sin(Math.PI * 8.0 / 6.0), Math.sin(Math.PI * 9.0 / 6.0), Math.sin(Math.PI * 9.0 / 6.0), Math.sin(Math.PI * 9.0 / 6.0), Math.sin(Math.PI * 10.0 / 6.0), Math.sin(Math.PI * 11.0 / 6.0), ],
			...
			//new <Number>[1.0, 0.5, 0.0, -0.5, -1.0],
			//new <Number>[1.0, -1.0, 0.0, 0.0], resembles pulse wide
